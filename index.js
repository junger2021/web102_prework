...
const unfundedGamesMessage = unfundedGamesCount === 0
    ...
    : `${unfundedGamesCount} games have not yet reached their funding goal.`;

// create a new DOM element containing the template string and append it to the description container
const unfundedGamesElement = document.createElement('p');
unfundedGamesElement.innerHTML = unfundedGamesMessage;
...
firstGameContainer.innerHTML = `<h3>${topGame.name}</h3><p>Pledged: $${topGame.pledged}</p>`;

// do the same for the runner up item
secondGameContainer.innerHTML = `<h3>${runnerUpGame.name}</h3><p>Pledged: $${runnerUpGame.pledged}</p>`;
